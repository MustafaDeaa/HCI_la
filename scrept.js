...
const text=[
        ...
        {id:'PBS',desc:`<h4>PBS Space Time</h4>
...
function displaytext(){
    for(let i=0;i<text.length;i++){
        let element = document.getElementById(text[i].id);
        if(element){
            element.innerHTML = text[i].desc;
        }
